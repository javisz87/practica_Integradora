...
try {
    await mongoose.connect('mongodb+srv://javiszumilo87:llZ08i3nzQY1ZzUw@cluster0.copndnv.mongodb.net/') // conecta con la base de datos
    const serverHttp = app.listen(PORT, () => console.log('Base de datos Conectada')) // levanta el servidor en el puerto especificado  
